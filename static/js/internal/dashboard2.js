...
//						$('#dashboardprime > div.main').html('').html(data);
						...
						var htmlstr = '<html><head></head><body style="font-family:Arial, sans-serif;"><table border="1" cellspacing="0" bordercolor="#222" id="clusterstable"><tbody><tr class="excelheader">';
						htmlstr += '<th>Name</th><th>Phone</th><th>Start address</th><th>End address</th><th>Start zone</th><th>End zone</th><th>Start subarea</th><th>End subarea</th><th>Start city</th><th>End city</th><th>Start time</th><th>End time</th><th>Direction</th><th>Seats</th><th>Fare</th><th>Status</th><th>Code</th><th>Id</th><th>Admin</th></tr>';
							...
							for(var j = 0; j < cluster.length ; j++){
                                ...
                                htmlstr += '<td>'+cluster[j].fare__amount+'</td>';
...
//						$('#dashboardprime > div.main').html('').html(data);
						...
						var htmlstr = '<html><head></head><body style="font-family:Arial, sans-serif;"><table border="1" cellspacing="0" bordercolor="#222" id="clusterstable"><tbody><tr class="excelheader">';
						htmlstr += '<th>Name</th><th>Phone</th><th>Start address</th><th>End address</th><th>Start zone</th><th>End zone</th><th>Start subarea</th><th>End subarea</th><th>Start city</th><th>End city</th><th>Start time</th><th>End time</th><th>Seats</th><th>Bucket</th><th>Source</th><th>Source Id</th><th>Id</th><th>Admin</th></tr>';
