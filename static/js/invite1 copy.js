var request, pickupzone_selected = false, dropzone_selected=false, currentIndex = 0, price = 0, place1, place2, pickupzone_id, dropzone_id;
					...
					function(data) {
						if (data.status == "success"){
							...
							if (data.av_status == "A"){
								...
								$('.invite_header div.content div.card.postsignup.result p').html("We do not have services available on this route. We will contact you if and when we start facilities on this route. We regret our inability to serve you at the moment.");
							}
...
//		increaseArea: '20%' // optional
	...
	var zone_options = JSON.parse($(".invite_header").attr('data-zones'));
